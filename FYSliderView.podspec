...
有两种风格的文字标题遮罩背景（渐变色背景/半透明背景）
  ...
  # s.screenshots  = "raw.githubusercontent.com/eppeo/FYSliderView/master/Resources/banner1.gif", "raw.githubusercontent.com/eppeo/FYSliderView/master/Resources/banner0.gif"
  ...
  # s.social_media_url   = "http://weibo.com/eppeo"
  ...
  s.source       = { :git => "https://github.com/eppeo/FYSliderView.git", :tag => "s.version.to_s" }
